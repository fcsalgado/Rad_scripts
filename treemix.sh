...
for m  in $(echo {1..10});  
do /mnt/c/Users/facas/Documents/treemix-1.13/src/./treemix -i treemix_input.frq.gz -m $m -noss -g out_topology.vertices.gz out_topology.edges.gz -o out_migration"$m"_"$i";done;done
